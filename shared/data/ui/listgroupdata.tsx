...
export const ContextualButtons = [
  { id: 1, text: 'A simple default list group item', class: 'light' },
  { id: 2, text: 'A simple primary list group item', class: 'primary' },
  { id: 3, text: 'A simple secondary list group item', class: 'secondary' },
  { id: 4, text: 'A simple success list group item', class: 'success' },
  { id: 5, text: 'A simple danger list group item', class: 'danger' },
  { id: 6, text: 'A simple warning list group item', class: 'warning' },
  { id: 7, text: 'A simple info list group item', class: 'info' },
  { id: 8, text: 'A simple light list group item', class: 'light' },
  { id: 9, text: 'A simple dark list group item', class: 'dark text-dark' }
];
export const ContextualButtons1 = [
  { id: 1, text: 'A simple default list group item', class: 'light' },
  { id: 2, text: 'A simple primary list group item', class: 'primary' },
  { id: 3, text: 'A simple secondary list group item', class: 'secondary' },
  { id: 4, text: 'A simple success list group item', class: 'success' },
  ...
  { id: 7, text: 'A simple info list group item', class: 'info' },
  { id: 8, text: 'A simple light list group item', class: 'light' },
  { id: 9, text: 'A simple dark list group item', class: 'dark text-white' }
];
//Custom
