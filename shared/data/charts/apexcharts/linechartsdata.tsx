...
export class Zoomabletime extends Component<{}, spark3> {
    ...
    render() {
        return (
            <ReactApexChart options={this.state.options} series={this.state.series} type="area" height={300}  width={"100%"}/>
...
export class Brushchart extends Component<{}, spark3> {
    ...
    render() {
        return (
            <div id="wrapper">
                <div id="brush-chart1">
                    <ReactApexChart options={this.state.options} series={this.state.series} type="line" height={230} width={"100%"} />
                </div>
                <div id="brush-chart">
                    <ReactApexChart options={this.state.optionsLine} series={this.state.seriesLine} type="area" height={130} width={"100%"} />
                </div>
            </div>
...
export class Syncing extends Component<{}, spark3> {
    ...
    render() {
        return (
            <div id="wrapper">
                <div id="chart-line">
                    <ReactApexChart options={this.state.options} series={this.state.series} type="line" height={160} width={"100%"} />
                </div>
                <div id="chart-line2">
                    <ReactApexChart options={this.state.optionsLine2} series={this.state.seriesLine2} type="line" height={160} width={"100%"} />
                </div>
                <div id="chart-area">
                    <ReactApexChart options={this.state.optionsArea} series={this.state.seriesArea} type="area" height={160} width={"100%"} />
                </div>
            </div>
