            ...
            <div className="main-content landing-main" onClick={handleClick}>
                ...
                <section className="section section-bg " id="statistics">
                    <div className="container text-center position-relative">
                        ...
                        <Row className=" justify-content-center">
                            <Col xl={7}>
                                <p className="text-muted fs-15 mb-5 fw-normal">We are proud to have top className clients and customers,which motivates us to work more on projects.</p>
                            </Col>
                        </Row>
                ...
                <section className="section section-bg " id="our-mission">
                    <div className="container text-center">
                        ...
                        <div className="row justify-content-center mb-5">
                            <Col xl={7}>
                                <p className="text-muted fs-15mb-0 fw-normal">Our mission is to make web design easy, so you can focus on building your brand.</p>
                            </Col>
                        </div>
                        <Row>
                            ...
                            <Card className="custom-card overflow-hidden shadow-none">
                                <Card.Body className="p-0">
                                    <Tab.Content className="" id="myTabContent">
                                        ...
                                        <Tab.Pane eventKey="2" className="p-0" id="pricing-yearly-pane"
                                    ...
                                    <Col xl={6}>
                                        <Accordion className=" accordion-customicon1 accordion-primary accordions-items-seperate" id="accordionFAQ1" defaultActiveKey='0'>
                                            <Accordion.Item eventKey='0'>
                                                ...
                                                <Accordion.Collapse id="collapsecustomicon1One" className="accordion-collapse collapse " eventKey='0'
                                                >
                                                    <Accordion.Body>
                ...
                <div className="text-center landing-main-footer py-3">
                    <span className="text-muted fs-15">@ Copyright 2024 <span id="year"></span> <Link
                        href="#!" scroll={false} className="text-primary fw-semibold"><u>ynex</u></Link>.
                        Designed with <span className="fa fa-heart text-danger"></span> by <Link href="#!" scroll={false} className="text-primary fw-semibold"><u>
                            Spruko</u>
                        </Link> All
                        rights
                        reserved
