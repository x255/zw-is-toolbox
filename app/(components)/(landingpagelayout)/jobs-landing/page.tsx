...
const Jobslandings = ({ ThemeChanger }:any) => {
    useEffect(() => {
    ...
    return (
        <Fragment>
            ...
            <HelmetProvider>
                            ...
                            <nav className="main-menu-container nav nav-pills sub-open">
                                ...
                                <div className="d-lg-flex d-none">
                                    <div className="btn-list d-lg-flex d-none mt-lg-2 mt-xl-0 mt-0">
                                        ...
                                        <Button variant='' className="btn btn-wave btn-icon btn-light switcher-icon" data-bs-toggle="offcanvas" data-bs-target="#switcher-canvas" onClick={() => Switchericon()}>
                                            <i className="ri-settings-3-line"></i>
                                        </Button>
                                    </div>
                                </div>
                ...
                <div className="main-content p-0 landing-main" onClick={handleClick}>
                                        ...
                                        <div className="">
                                            ...
                                            <div className="mb-3 custom-form-group">
                                                ...
                                                <div className="custom-form-btn bg-transparent">
                                                    ...
                                                    <button className="btn btn-primary border-0" type="button"><i className="bi bi-search me-sm-2"></i> <span>Search</span></button>
                                                </div>
                                            </div>
                                        </div>
                                    </Col>
                            ...
                            <Row>
                                    ...
                                    <Card className=" custom-card border">
                                        <Row className="g-0">
                                            <Col md={3} className="col-4">
                                                <img src="../assets/images/media/jobs-landing/1.jpg" className="img-fluid rounded-start h-100 browse-jobs-image" alt="..." />
                                            </Col>
                                            <Col md={9} className="col-8 my-auto">
                                                <Card.Body>
                                                    <Card.Title as='h5' className="fw-semibold">Business Development</Card.Title>
                                                    <p><span className="text-default fw-semibold">120 Jobs</span> available</p>
                                                    <Link className="text-primary fw-semibold" href="#!" scroll={false}>Explore Jobs<i className="ri-arrow-right-s-line align-middle transform-arrow lh-1"></i></Link>
                                                </Card.Body>
                                            </Col>
                                        </Row>
                                    </Card>
                                ...
                                <Col lg={4} md={6} className="col-12">
                                    <Card className=" custom-card border">
                                        <Row className=" g-0">
                                            <Col md={3} className="col-4">
                                                <img src="../assets/images/media/jobs-landing/2.jpg" className="img-fluid rounded-start h-100 browse-jobs-image" alt="..." />
                                            </Col>
                                            <Col md={9} className="col-8 my-auto">
                                                <Card.Body>
                                                    <Card.Title as='h5' className=" fw-semibold">Customer Support</Card.Title>
                                ...
                                <Col lg={4} md={6} className="col-12">
                                    <Card className=" custom-card border">
                                        <Row className=" g-0">
                                            <Col md={3} className="col-4">
                                                <img src="../assets/images/media/jobs-landing/3.jpg" className="img-fluid rounded-start h-100 browse-jobs-image" alt="..." />
                                            </Col>
                                            <Col md={9} className=" col-8 my-auto">
                                                <Card.Body>
                                                    <Card.Title as='h5' className="fw-semibold">Marketing</Card.Title>
                                ...
                                <div className="col-12 col-lg-4 col-md-6">
                                    <Card className=" custom-card border">
                                        <Row className=" g-0">
                                            <Col md={3} className="col-4">
                                                <img src="../assets/images/media/jobs-landing/4.jpg" className="img-fluid rounded-start h-100 browse-jobs-image" alt="..." />
                                            </Col>
                                            <Col md={9} className="col-8 my-auto">
                                                <Card.Body>
                                                    <Card.Title as='h5' className="fw-semibold">Product Management</Card.Title>
                                ...
                                <Col lg={4} md={6} className="col-12">
                                    <Card className=" custom-card border">
                                        <Row className=" g-0">
                                            <Col md={3} className="col-4">
                                                <img src="../assets/images/media/jobs-landing/5.jpg" className="img-fluid rounded-start h-100 browse-jobs-image" alt="..." />
                                            </Col>
                                            <Col md={9} className="col-8 my-auto">
                                                <Card.Body>
                                                    <Card.Title as='h5' className="fw-semibold">Accountant</Card.Title>
                                ...
                                <Col lg={4} md={6} className="col-12">
                                    <Card className=" custom-card border">
                                        <Row className=" g-0">
                                            <Col md={3} className="col-4">
                                                <img src="../assets/images/media/jobs-landing/6.jpg" className="img-fluid rounded-start h-100 browse-jobs-image" alt="..." />
                                            </Col>
                                            <Col md={9} className="col-8 my-auto">
                                                <Card.Body>
                                                    <Card.Title as='h5' className="fw-semibold">Technical Support</Card.Title>
                                ...
                                <Col md={4} className="col-12">
                                    <Card className=" custom-card border">
                                        <Card.Body className="rounded">
                                            ...
                                            <Link className="mx-1 text-primary fw-semibold" href="#!" scroll={false}>Register Now<i className="ri-arrow-right-s-line align-middle transform-arrow lh-1"></i></Link>
                                        </Card.Body>
                                    </Card>
                                </Col>
                                <Col md={4} className="col-12">
                                    <Card className=" custom-card border">
                                        <Card.Body className="rounded">
                                            ...
                                            <Link className="mx-1 text-primary fw-semibold" href="#!" scroll={false}>Complete Profile<i className="ri-arrow-right-s-line align-middle transform-arrow lh-1"></i></Link>
                                        </Card.Body>
                                    </Card>
                                </Col>
                                <Col md={4} className="col-12">
                                    <Card className="custom-card border">
                                        <Card.Body className="rounded">
                                            ...
                                            <Link className="mx-1 text-primary fw-semibold" href="#!" scroll={false}>Apply Now<i className="ri-arrow-right-s-line align-middle transform-arrow lh-1"></i></Link>
                                        </Card.Body>
                                    </Card>
                                </Col>
                            </Row>
                    ...
                    <section className="section bg-banner-2 text-fixed-white py-0">
                        <div className="container">
                            <Row className=" align-items-center justify-content-center">
                                ...
                                <Col md={7} xl={8}>
                                    <div className="my-4">
                                        <h2 className="fw-semibold mb-3 text-fixed-white">Are You Looking For A Job? Just <Link href="#!" scroll={false} className="text-fixed-white text-decoration-line"> <u>drop</u> </Link> resume..</h2>
                                        ...
                                        <Link href="#!" scroll={false} className="btn btn-light btn-lg"><i className="ti ti-upload"></i> Upload Your Resume</Link>
                                    </div>
                                </Col>
                            </Row>
                        </div>
                    ...
                    <section className="section" id="features">
                        <div className="container">
                                    ...
                                    <Card className=" custom-card featured-jobs">
                                        <Card.Body>
                                            <div className="btn-list float-end">
                                                <Link href="#!" scroll={false} className="wishlist-icon" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="Add to wishlist"><span><i className="bi bi-heart"></i></span></Link>
                                                <Link href="#!" scroll={false} className="wishlist-icon text-warning" data-bs-toggle="tooltip"
                                            ...
                                            <div className="popular-tags mb-3">
                                                <Link href="#!" scroll={false} className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-geo-alt text-muted me-1"></i> Hyderabad</Link>
                                                <Link href="#!" scroll={false} className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-briefcase text-muted me-1"></i> 13 Openings</Link>
                                                ...
                                                <Link href="#!" scroll={false} className="badge rounded-pill bg-light text-default me-1"><i className="bi bi-clock text-muted me-1"></i> Min - 2Years</Link>
                                            ...
                                            <div className="d-flex justify-content-between">
                                                ...
                                                <Link href="#!" scroll={false} className="text-primary fw-semibold fs-14 d-inline-flex align-items-center">
                                                    Apply Now <i className="fe fe-arrow-right lh-1 transform-arrow"></i>
                                                </Link>
                                            </div>
                                        </Card.Body>
                                    </Card>
                            ...
                            <div className="text-center">
                                <Link href="#!" scroll={false} className="btn btn-lg btn-wave btn-primary">
                    ...
                    <section className="section bg-primary">
                        <div className="container">
                            <Row className=" justify-content-center text-center mb-5 text-fixed-white">
                                <Col xl={6}>
                                    <h3 className="fw-semibold mb-2 text-fixed-white">Which Type Of Job You Want ?</h3>
                                ...
                                <Col lg={3} md={6} sm={6}>
                                    <Card className=" feature-style">
                                        <Card.Body>
                                            ...
                                            <Link className="text-primary fw-semibold" href="#!">Explore Jobs<i className="ri-arrow-right-s-line align-middle transform-arrow lh-1"></i></Link>
                                        </Card.Body>
                                    </Card>
                                </Col>
                                <Col lg={3} md={6} sm={6}>
                    ...
                    <section className="section bg-banner-1 bg-light py-0" id="candidate">
                        <div className="container">
                            <div className="row align-items-center justify-content-center">
                                <div className="col-lg-4 d-lg-block d-none text-center mt-4">
                                    <img src="../assets/images/media/jobs-landing/7.png" width="260" alt="" />
                                </div>
                                <div className="col-md-8 my-4">
                                    <h2 className="fw-semibold mb-3">Are You Looking For A best Candidate? <br /> Just <Link href="#!" scroll={false} className="text-primary text-decoration-line"> <u>Publish</u> </Link> your job here..</h2>
                                    ...
                                    <Link href="#!" scroll={false} className="btn btn-primary btn-lg"><i className="ti ti-upload"></i> Publish new job</Link>
                                </div>
                            </div>
                        </div>
                    </section>
                            ...
                            <Row className=" row-cols-1 row-cols-md-3 g-4">
                                <Col>
                                    <Card className=" custom-card border shadow-none">
                                        ...
                                        <Card.Body>
                                            <Badge bg=" bg-secondary blog-badge">Interview</Badge>
                                            ...
                                            <Link className="text-primary fw-semibold" href="#!" scroll={false}>Read this post<i className="ri-arrow-right-s-line align-middle transform-arrow lh-1"></i></Link>
                                        </Card.Body>
                                    </Card>
                                </Col>
                                <Col>
                                    <Card className=" custom-card border shadow-none">
                                        ...
                                        <Card.Body>
                                            <Badge bg=" bg-danger blog-badge">Freelancer</Badge>
                                ...
                                <Col>
                                    <Card className=" custom-card border shadow-none">
                                        ...
                                        <Card.Body>
                                            <Badge bg=" bg-warning blog-badge">Jobmaster</Badge>
                    ...
                    <section className="section bg-banner" id="employers">
                        <div className="container">
                            <Row>
                                <Col lg={9}>
                                    <h2 className="fw-semibold text-fixed-white">Let Employers easy to find you !</h2>
                            ...
                            <Row className=" justify-content-center">
                                <Col xxl={4} xl={4} lg={3} md={6} sm={6} className="col-12">
                                    <Card className=" custom-card text-start featured-card-4">
                                        <Link href="#!" scroll={false} className="open-link"></Link>
                    ...
                    <section className="section landing-testimonials">
                        <div className="container text-center">
                            ...
                            <div className=" pagination-dynamic text-start">
                                <Swiper spaceBetween={30} centeredSlides={true} autoplay={{ delay: 2500, disableOnInteraction: false, }} pagination={{ clickable: true }} modules={[Pagination, Autoplay]} className="mySwiper">
                                    <SwiperSlide>
                                        <Row>
                                            <Col xxl={4} xl={6} lg={6} md={6} sm={12}>
                                                <Card className="card custom-card featured-card-1 border shadow-none">
                                            ...
                                            <Col xxl={4} xl={6} lg={6} md={6} sm={12}>
                                                <Card className=" custom-card featured-card-1 border shadow-none">
                                                    <Card.Body className="p-4">
                                                        <span className="review-quote">
                                                            <i className="bi bi-quote"></i>
                                                        </span>
                                    ...
                                    <SwiperSlide>
                                        <Row>
                                            ...
                                            </Col>   <Col xxl={4} xl={6} lg={6} md={6} sm={12}>
                                                <Card className=" custom-card featured-card-1 border shadow-none">
                                                    <Card.Body className=" p-4">
                                                        <span className="review-quote">
                                                            <i className="bi bi-quote"></i>
                    ...
                    <section className="section bg-banner" id="career-advice">
                        <Row className=" justify-content-center">
                            <Col lg={6} className="text-center">
                                <div className="mb-4">
                                    <h3 className="fw-semibold mb-2 text-fixed-white">&#128512; Your dream job is waiting for you !</h3>
                                </div>
                                <span className="fs-15 fw-normal op-8 d-block mb-4 px-lg-0 px-3">Est amet sit vero sanctus labore no sed ipsum ipsum nonumy. Sit ipsum sanctus ea magna est. Aliquyam sed amet. Kasd diam rebum sit ipsum ipsum erat et kasd.Est amet sit vero sanctus labore no sed ipsum ipsum nonumy vero sanctus labore..</span>
                                <Link href="#!" scroll={false} className="btn btn-lg btn-light m-1"><i className="bi bi-search me-1"></i> Search Jobs</Link>
                                <Link href="#!" scroll={false} className="btn btn-lg btn-danger m-1"><i className="bi bi-send me-1"></i> Apply Job Now</Link>
                            </Col>
                        </Row>
                    </section>
                    <div className="landing-main-footer py-3">
                        <div className="container">
                            <div className="d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                <div>
                                    <span className="text-fixed-white op-7 fs-14"> © Copyright 2024 <span id="year"></span> <Link
                                        href="#!" scroll={false} className="text-primary fs-15 fw-semibold">Ynex</Link>.
                                    </span>
                                </div>
                                <div>
                                    <ul className="list-unstyled fw-normal landing-footer-list mb-0">
                                        <li>
                                            <Link href="#!" scroll={false} className="text-fixed-white op-8">Terms Of Service</Link>
                                        </li>
                                        <li>
                                            <Link href="#!" scroll={false} className="text-fixed-white op-8">Privacy Policy</Link>
                                        </li>
                                        <li>
                                            <Link href="#!" scroll={false} className="text-fixed-white op-8">Legal</Link>
                                        </li>
                                        <li>
                                            <Link href="#!" scroll={false} className="text-fixed-white op-8">Contact</Link>
                                        </li>
                                        <li>
                                            <Link href="#!" scroll={false} className="text-fixed-white op-8">Report Abuse</Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
export default connect(mapStateToProps, { ThemeChanger })(Jobslandings);
