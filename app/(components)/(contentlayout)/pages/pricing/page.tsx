...
import { Badge, Card, Col, Nav, Row, Tab, TabContainer } from 'react-bootstrap'
                    ...
                    <TabContainer defaultActiveKey='one'>
                        ...
                        <Col xl={12}>
                            <Tab.Content className="tab-content" id="myTabContent1">
                                <Tab.Pane eventKey="one" className="tab-pane p-0 border-0" id="pricing-monthly1-pane"
                                                ...
                                                <Card.Body className=" p-0">
                                                    ...
                                                    <div className="p-4">
                                                        <div className="d-flex justify-content-between align-items-center mb-3">
                                                            ...
                                                            <div>
                                                                <Badge bg=" bg-success-transparent">For Indivudials</Badge>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <ul className="list-unstyled mb-0">
                                                            ...
                                                            <li className="d-grid">
                                                                <button className="btn btn-light btn-wave">Choose Plan</button>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </Card.Body>
                                                ...
                                                <Card.Body className="p-0">
                                                    ...
                                                    <div className="p-4">
                                                        ...
                                                        <ul className="list-unstyled mb-0">
                                                            ...
                                                            <li className="d-grid">
                                                                <button className="btn btn-primary btn-wave">Choose Plan</button>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </Card.Body>
                                ...
                                <Tab.Pane eventKey="two" className="tab-pane p-0 border-0" id="pricing-yearly1-pane"
                                                ...
                                                <Card.Body className="p-0">
                                                    ...
                                                    <div className="p-4">
                                                        <div className="d-flex justify-content-between align-items-center mb-3">
                                                            <div className="fs-18 fw-semibold">Free</div>
                                                            <div>
                                                                <Badge className="bg-success-transparent">For Indivudials</Badge>
                                                            </div>
                                                        </div>
                                            ...
                                            <Row>
                                                <Col xxl={4} xl={4} lg={4} md={4} sm={12} className=" border-end border-inline-end-dashed pe-0">
                                                    <div className="p-4">
                                                        ...
                                                        <div className="d-grid">
                                                            <button className="btn btn-primary-light btn-wave">Get Started</button>
                                                        </div>
                                                    </div>
                                                </Col>
                                                <Col xxl={4} xl={4} lg={4} md={4} sm={12} className="border-end border-inline-end-dashed px-0">
                                                    <div className="p-4">
                                                        ...
                                                        <ul className="list-unstyled text-center fs-12 px-3 pt-3 mb-0">
                                                            <li className="mb-3">
                                                                <span className="text-muted">Storage Capacity<Badge bg=" bg-light text-default ms-1">5Tb</Badge></span>
                                                            </li>
                                                            <li className="mb-3">
                                                                <span className="text-muted">Daily Updates<Badge bg=" bg-light text-default ms-1">Unlimited</Badge></span>
                                                            </li>
                                                            <li className="mb-3">
                                                                <span className="text-muted">Online Support</span>
                                                            </li>
                                                            <li className="mb-3">
                                                                <span className="text-muted">Visitors Monitoring<Badge bg=" bg-light text-default ms-1">24/7</Badge></span>
                                                            </li>
                                                            <li className="mb-3">
                                                ...
                                                <Col xxl={4} xl={4} lg={4} md={4} sm={12} className="ps-0">
                                                    <div className="p-4 pricing-offer overflow-hidden">
                                                        ...
                                                        <ul className="list-unstyled text-center fs-12 px-3 pt-3 mb-0">
                                                            <li className="mb-3">
                                                                <span className="text-muted">Storage Capacity<Badge bg=" bg-light text-default ms-1">10Tb</Badge></span>
                                                            </li>
                                                            <li className="mb-3">
                                                                <span className="text-muted">Daily Updates<Badge bg=" bg-light text-default ms-1">Unlimited</Badge></span>
                                                            </li>
                                                        ...
                                                        <div className="d-grid">
                                                            <button className="btn btn-primary btn-wave">Get Started</button>
                                                        </div>
                                                    </div>
                                                </Col>
                                            </Row>
                                        </Tab.Pane>
                                        <Tab.Pane eventKey="two" className="tab-pane p-0 border-bottom-0" id="pricing-yearly-pane"
                                            ...
                                            <Row>
                                                <Col xxl={4} xl={4} lg={4} md={4} sm={12} className="border-end border-inline-end-dashed pe-0">
                                                    <div className="p-4">
                                                        ...
                                                        <ul className="list-unstyled text-center fs-12 px-3 pt-3 mb-0">
                                                            <li className="mb-3">
                                                                <span className="text-muted">Storage Capacity<Badge bg=" bg-light text-default ms-1">1Tb</Badge></span>
                                                            </li>
                                                            <li className="mb-3">
                                                                <span className="text-muted">Daily Updates<Badge bg=" bg-light text-default ms-1">Unlimited</Badge></span>
                                                            </li>
                                    ...
                                    <table className="table table-bordered text-nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span>
                                                        24/7 support <Badge bg=" bg-primary ms-2">1
                                                            Year</Badge>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span>
                                                        24/7 support <Badge bg=" bg-primary ms-2">5
                                                            Year</Badge>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span>
                                                        24/7 support <Badge bg=" bg-primary ms-2">Life
                                                            Long</Badge>
                                                    </span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <span>
                                                        Storage Capacity <Badge bg=" bg-success ms-2">1
                                                            TB</Badge>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span>
                                                        Storage Capacity <Badge bg=" bg-success ms-2">5
                                                            TB</Badge>
                                                    </span>
                                                </td>
                                                <td>
                                                    <span>
                                                        Storage Capacity <Badge bg=" bg-success ms-2">10
                                                            TB</Badge>
                                                    </span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <Badge
                                                        bg=" bg-success-transparent p-1 lh-1 rounded-circle">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <Badge
                                                        bg=" bg-danger-transparent p-1 lh-1 rounded-circle">
                                            ...
                                            <tr>
                                                ...
                                                <td className="border-bottom-0">
                                                    <button className="btn btn-primary btn-wave">Choose
                                                        Plan</button>
                                                </td>
                                                <td className="border-bottom-0">
                                                    <button className="btn btn-primary btn-wave">Choose
