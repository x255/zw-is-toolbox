...
import { Badge, Button, Col, Dropdown, Nav, Row, Tab, TabContainer, TabContent, InputGroup, Form, Card } from 'react-bootstrap'
                ...
                <div className="main-chart-wrapper p-2 gap-2 d-lg-flex">
                    <div className="chat-info border">
                        ...
                        <div className="d-flex align-items-center justify-content-between w-100 p-3 border-bottom">
                            ...
                            <Dropdown>
                                <Dropdown.Toggle variant='' className="btn btn-icon btn-secondary-light btn-wave waves-light waves-effect waves-light no-caret" type="button">
                        ...
                        <div className="chat-search p-3 border-bottom">
                            <InputGroup>
                                ...
                                <Button variant='primary' aria-label="button" className="" type="button" id="button-addon2"><i
                            ...
                            <Tab.Content className="" id="myTabContent">
                                <Tab.Pane eventKey="first" className="fade border-0 chat-users-tab" id="users-tab-pane"
                                    ...
                                    <SimpleBar id="chat-msg-scroll" className="chat-users-tab">
                                        {chatData.map((section: any, index: React.Key | null | undefined) => (
                                            <ul className="list-unstyled mb-0 mt-2 " id="chat-msg-scroll" key={index} onClick={mainChartWrapper}>

                                                <li className="pb-0" >
                                                    <p className="text-muted fs-11 fw-semibold mb-2 op-7">{section.heading}</p>
                                                </li>
                                                {section.users.map((chatUser: any, userIndex: React.Key | null | undefined) => (
                    ...
                    <div className="main-chat-area border">
                        ...
                        <div className="d-sm-flex align-items-center p-2 border-bottom">
                            ...
                            <div className="d-flex rightIcons">
                                <Button variant='' aria-label="button" type="button" className="btn btn-icon btn-outline-light my-1 ms-2">
                                    <i className="ti ti-phone"></i>
                                </Button>
                                <Button variant='' aria-label="button" type="button" className="btn btn-icon btn-outline-light my-1 ms-2">
                                    <i className="ti ti-video"></i>
                                </Button>
                                <Button variant='' aria-label="button" type="button" className="btn btn-icon btn-outline-light my-1 ms-2 responsive-userinfo-open" onClick={Chartuser}>
                                    <i className="ti ti-user-circle" id="responsive-chat-close"></i>
                                </Button>
                                <Dropdown className='d-inline-block'>
                                    <Dropdown.Toggle variant='transparent' className="btn btn-icon btn-outline-light  no-caret my-1 btn-wave waves-light ms-2">
                                    ...
                                    <li className="chat-item-end">
                                        <div className="chat-list-inner">
                                            <div className="me-3">
                                                ...
                                                <div className="main-chat-msg">
                                                    <div className="">
                                                        <Link aria-label="anchor" href="#!" scroll={false} className="text-fixed-white"><i
                    ...
                    <div className="chat-user-details border" id="chat-user-details">
                        <SimpleBar>
                            <div className=' chat-user'>
                                <Button variant='' aria-label="button" onClick={Chartuser1} type="button" className="btn btn-icon btn-outline-light my-1 ms-2 responsive-chat-close2">
                                    <i className="ri-close-line"></i>
                                </Button>
