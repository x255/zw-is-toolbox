...
import { Backgroundcards, Gridcards, Gridmarkupcards, Mountaincards } from '../../../../../shared/data/ui/cardsdata'
            ...
            <Row>
                <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
                    <Card className=" custom-card">
                        ...
                        <Card.Body>
                            ...
                            <Link href="#!" scroll={false} className="btn btn-primary">Read More</Link>
                        </Card.Body>
                        <Card.Footer>
                ...
                <Col xxl={3} xl={6} lg={6} md={6} sm={12}>
                    <Card className=" custom-card">
                        ...
                        <Card.Body>
                            <Link href="#!" scroll={false} className="card-link text-primary">Card link</Link>
                            <Link href="#!" scroll={false} className="card-link text-secondary d-inline-block">Another link</Link>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
                            ...
                            <Col key={Math.random()}>
                                <Card className=" custom-card">
                                    <Card.Body>
                                        ...
                                        <Link href="#!" scroll={false} className={`btn btn-${idx.color}`}>Purchase</Link>
                                    </Card.Body>
                                </Card>
                            </Col>
                        ))}
                ...
                <Col xl={3}>
                    <Card className=" custom-card text-center">
                        ...
                        <Card.Body>
                            ...
                            <Link href="#!" scroll={false} className="btn btn-primary mt-2 me-2">Read More</Link>
                            <Link href="#!" scroll={false} className="btn btn-outline-secondary mt-2">Close</Link>
                        </Card.Body>
                ...
                <Col xl={4}>
                    <Card className="custom-card">
                        <Card.Header className="card-header justify-content-between">
                            ...
                            <Link href="#!" scroll={false} onClick={BasicHandleExpandClick}><i className={`fe ${BasicExpanded ? 'fe-chevron-up' : 'fe-chevron-down'}`}></i></Link>
                        </Card.Header>
                    ...
                    {Basicshow ?
                        <Card className="custom-card">
                            <Card.Header className="card-header justify-content-between">
                                ...
                                <Link href="#!" scroll={false} data-bs-toggle="card-remove" onClick={() => setBasicshow(false)}>
            ...
            <Row>
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card className=" custom-card w-75">
                                ...
                                <Card.Footer>
                                    <Link href="#!" scroll={false} className="btn btn-primary d-grid">Button</Link>
                                </Card.Footer>
                            </Card>
                        </Col>
                        <Col xl={6}>
                ...
                <Col xxl={6} xl={12}>
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card className=" custom-card text-center">
                                <Card.Header className="p-4 pt-3 ps-2">
                                    <ul className="nav nav-tabs card-header-tabs ms-1">
                                        <li className="nav-item">
                                            <Link className="nav-link active" aria-current="true" href="#!" scroll={false}>Active</Link>
                                        </li>
                                        <li className="nav-item">
                                            <Link className="nav-link" scroll={false} href="#!">Link</Link>
                                        </li>
                                        <li className="nav-item">
                            ...
                            <Card className=" text-center custom-card">
                                <Card.Header>
                                    <ul className="nav nav-pills card-header-pills ms-1">
                                        <li className="nav-item">
                                            <Link className="nav-link active" href="#!" scroll={false}>Active</Link>
                                        </li>
                                        <li className="nav-item">
                ...
                <Col xl={4}>
                    <Card className=" custom-card overlay-card">
                        ...
                        <div className="card-img-overlay d-flex flex-column p-0 over-content-bottom">
                            <Card.Body className="text-fixed-white text-truncate">
                            ...
                            <Card.Body>
                                <div className="d-flex align-items-center w-100">
                                    ...
                                    <div className="ms-auto">
                                        <Link href="#!" scroll={false} className="text-fixed-white"><i className="bi bi-three-dots-vertical"></i></Link>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
                    ...
                    <Card className=" border border-primary custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">Home Page Design
                                <Link href="#!" scroll={false}><i className="bi bi-plus-square float-end text-primary fs-18"></i></Link>
                            </p>
                    ...
                    <Card className=" border border-secondary custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">Landing Page Design
                                <Link href="#!" scroll={false}><i className="bi bi-plus-square float-end text-secondary fs-18"></i></Link>
                            </p>
                            <div className="d-flex flex-wrap gap-2 mb-4">
                                <Badge bg=" bg-danger-transparent">Laravel</Badge>
                                <Badge bg=" bg-teal-transparent">Codeignitor</Badge>
                    ...
                    <Card className=" border border-warning custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">Update New Project
                                <Link href="#!" scroll={false}><i className="bi bi-plus-square float-end text-warning fs-18"></i></Link>
                            </p>
                            <div className="d-flex flex-wrap gap-2 mb-4">
                                <Badge bg=" bg-warning-transparent">Html</Badge>
                                <Badge bg=" bg-secondary-transparent">Bootstrap</Badge>
                    ...
                    <Card className=" border border-info custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">New Project Discussion
                                <Link href="#!" scroll={false}><i className="bi bi-plus-square float-end text-info fs-18"></i></Link>
                            </p>
                            <div className="d-flex flex-wrap gap-2 mb-4">
                    ...
                    <Card className=" border border-danger custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">Recent Projects Testing
                                <Link href="#!" scroll={false}><i className="bi bi-plus-square float-end text-danger fs-18"></i></Link>
                            </p>
                            <div className="d-flex flex-wrap gap-2 mb-4">
                                <Badge bg=" bg-primary-transparent">Ui</Badge>
                                <Badge bg=" bg-secondary-transparent">Angular</Badge>
                                <Badge bg=" bg-info-transparent">Java</Badge>
                            </div>
                            <div className="avatar-list-stacked">
                                <span className="avatar avatar-sm avatar-rounded">
                                    <img src="../../assets/images/faces/15.jpg" alt="img" />
                    ...
                    <Card className=" border border-success custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">About Us Page redesign
                                <Link href="#!" scroll={false}><i className="bi bi-plus-square float-end text-success fs-18"></i></Link>
                            </p>
                            <div className="d-flex flex-wrap gap-2 mb-4">
                    ...
                    <Card className=" border border-light custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">New Employees
                                <Link href="#!" scroll={false}><i className="bi bi-plus-square float-end text-default fs-18"></i></Link>
                            </p>
                            <div className="d-flex flex-wrap gap-2 mb-4">
                                <Badge bg=" bg-warning-transparent">Html</Badge>
                                <Badge bg=" bg-info-transparent">Cake Php</Badge>
                                <Badge bg=" bg-success-transparent">React</Badge>
                            </div>
                            <div className="avatar-list-stacked">
                                <span className="avatar avatar-sm avatar-rounded">
                                    <img src="../../assets/images/faces/5.jpg" alt="img" />
                    ...
                    <Card className=" border border-dark custom-card">
                        <Card.Body>
                            <p className="fs-14 fw-semibold mb-2 lh-1">Terminated Employees
                                <Link href="#!" scroll={false}><i className="bi bi-plus-square float-end text-dark fs-18"></i></Link>
                            </p>
                            <div className="d-flex flex-wrap gap-2 mb-4">
                                <Badge bg=" bg-primary-transparent">Angular</Badge>
                            </div>
                            <div className="avatar-list-stacked">
                                <span className="avatar avatar-sm avatar-rounded">
                                    <img src="../../assets/images/faces/9.jpg" alt="img" />
