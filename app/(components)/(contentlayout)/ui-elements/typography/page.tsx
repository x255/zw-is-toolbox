...
import {typography1,typography2,typography3,typography4,typography5,typography6,typography7,typography8,typography9,typography10,typography11,typography12,typography13,typography14,typography15,typography16,typography17,typography18,typography19,
    typography20,typography21,typography22,typography23,typography24 , typography25 , typography26, typography27, typography28, typography29,typography30,typography31  } from '../../../../../shared/data/prismdata/uielements';
...
<Pageheader title="Typography" heading="Ui Elements" active="Typography" />
            <Row>
                <Col xl={6}>
                        ...
                        <ShowCode title="Headings H tags" code={typography1} >
                        ...
                        <ShowCode title="Heading Class Names" code={typography2} >
                ...
                <Col xl={6}>
                        ...
                        <ShowCode title="Display headings" code={typography3} >
                        ...
                        <ShowCode title="Customizing headings" code={typography4} >
                            <h3>
            ...
            <Row>
                <Col xl={6}>
                        ...
                        <ShowCode title="Inline text elements" code={typography5} >
                ...
                <Col xl={6}>
                        ...
                        <ShowCode title="Font Sizes" code={typography6} >
            ...
            <Row>
                <Col xl={12}>
                        ...
                        <ShowCode title="Lead Paragraph" code={typography7} >
            ...
            <Row>
                <Col xl={6}>
                        ...
                        <ShowCode title="Left Aligned" code={typography8}>
                ...
                <Col xl={6}>
                        ...
                        <ShowCode title="Right Aligned" code={typography9}>
            ...
            <Row>
                <Col xl={4}>
                        ...
                        <ShowCode title="Primary Blockquote" code={typography10}>
                ...
                <Col xl={4}>
                        ...
                        <ShowCode title="Secondary Blockquote" code={typography11}>
                ...
                <Col xl={4}>
                        ...
                        <ShowCode title="Warning Blockquote" code={typography12}>
                ...
                <Col xl={4}>
                        <ShowCode title="Success Blockquote" code={typography13}>
                ...
                <Col xl={4}>
                        ...
                        <ShowCode title="Success Blockquote" code={typography14}>
                ...
                <Col xl={4}>
                        <ShowCode title="Danger Blockquote" code={typography15}>
            ...
            <Row>
                <Col xl={6}>
                        ...
                        <ShowCode title="Description list alignment" code={typography16}>
                ...
                <Col xl={6}>
                        ...
                        <ShowCode title="List Unstyled" code={typography17}>
            ...
            <Row>
                ...
                <Col xl={6}>
                        ...
                        <ShowCode title="Horizontal rules" code={typography20}>
            ...
            <Row>
                <Col xl={6}>
                        ...
                        <ShowCode title="Text transform" code={typography21}>
                ...
                <Col xl={6}>
                        <ShowCode title="Text decoration" code={typography22}>
            ...
            <Row>
                <Col xl={6}>
                        ...
                        <ShowCode title="Font weight and italics" code={typography23}>
                ...
                <Col xl={6}>
                        ...
                        <ShowCode title="Line height" code={typography24}>
            ...
            <Row>
                <Col xl={3}>    
                        <ShowCode title="Monospace" code={typography25}>
                            <p className="font-monospace mb-0">This is in monospace</p>
                            </ShowCode>
                  
                </Col>
                <Col xl={3}>
                        <ShowCode title="Reset color" code={typography26}>
                ...
                <Col xl={3}>
                        <ShowCode title="Visible text" code={typography27}>
                ...
                <Col xl={3}>
                        ...
                        <ShowCode title="Invisible text" code={typography28}>
            ...
            <Row>
                <Col xl={6}>
                        ...
                        <ShowCode title="Text alignment" code={typography29}>
                ...
                <Col xl={6}>
                        <ShowCode title="Text wrapping and overflow" code={typography30}>
                        ...
                        <ShowCode title="Word break" code={typography31}>
