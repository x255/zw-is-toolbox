                ...
                <Col xl={12}>
                    <Card className=" custom-card">
                        <Card.Header className="justify-content-between">
                            <Card.Title>
                                Companies <Badge bg="light" text="default" className="rounded ms-1 fs-12 align-middle">14</Badge>
                            </Card.Title>
                ...
                <div className="offcanvas-body p-0">
                    <div className="d-sm-flex align-items-top p-4 border-bottom border-block-end-dashed main-profile-cover">
                        ...
                        <div className="flex-fill main-profile-info">
                            <div className="d-flex align-items-center justify-content-between">
                                ...
                                <Button variant='' onClick={handleClose} type="button" className="btn-close crm-contact-close-btn" data-bs-dismiss="offcanvas" aria-label="Close"></Button>
                            </div>
                    ...
                    <div className="p-4 border-bottom border-block-end-dashed d-flex align-items-center">
                        ...
                        <div className="btn-list mb-0">
                            <Button variant='' className="btn btn-sm btn-icon my-1 btn-primary-light btn-wave waves-effect waves-light mb-0">
                                <i className="ri-facebook-line fw-semibold"></i>
                            </Button>
                            <Button variant='' className="btn btn-sm btn-icon my-1 btn-secondary-light btn-wave waves-effect waves-light mb-0">
                                <i className="ri-twitter-x-line fw-semibold"></i>
                            </Button>
                            <Button variant='' className="btn btn-sm btn-icon my-1 btn-warning-light btn-wave waves-effect waves-light mb-0">
                                <i className="ri-instagram-line fw-semibold"></i>
                            </Button>
                            <Button variant='' className="btn btn-sm btn-icon my-1 btn-success-light btn-wave waves-effect waves-light mb-0">
                                <i className="ri-github-line fw-semibold"></i>
                            </Button>
                            <Button variant='' className="btn btn-sm btn-icon my-1 btn-danger-light btn-wave waves-effect waves-light mb-0">
