            ...
            <Row>
                    ...
                    <Card className="custom-card">
                        <Card.Body className=" p-3">
                            <div className="d-flex align-items-top flex-wrap justify-content-between">
                                <div> <div className="fw-semibold fs-15 lead-discovered">Leads Discovered</div>
                                    <span className=" badge bg-light text-default">24 Leads</span> </div> <div>
                                    <span className="text-primary fw-semibold">$25,238</span> </div> </div> </Card.Body>
                ...
                <Col xxl={2} md={4}>
                    <Card className="custom-card">
                        <Card.Body className="p-3">
                            <div className="d-flex align-items-top flex-wrap justify-content-between">
                                <div> <div className="fw-semibold fs-15 lead-qualified">Qualified Leads</div>
                                    <span className=" badge bg-light text-default">17 Leads</span> </div> <div>
                                    <span className="text-warning fw-semibold">$32,453</span> </div> </div> </Card.Body>
                ...
                <Col xxl={2} md={4}>
                    <Card className="custom-card">
                        <Card.Body className="p-3">
                            <div className="d-flex align-items-top flex-wrap justify-content-between">
                                <div> <div className="fw-semibold fs-15 contact-initiated">Contact Initiated</div>
                                    <span className=" badge bg-light text-default">5 Leads</span> </div> <div>
                                    <span className="text-success fw-semibold">$13,756</span> </div> </div>
                        </Card.Body>
                ...
                <Col xxl={2} md={4}>
                    <Card className="custom-card">
                        <Card.Body className="p-3"> <div className="d-flex align-items-top flex-wrap justify-content-between"> <div>
                            <div className="fw-semibold fs-15 need-identified">Needs Identified</div>
                            <span className=" badge bg-light text-default">43 Leads</span> </div> <div>
                                <span className="text-info fw-semibold">$47,093</span> </div> </div> </Card.Body>
                ...
                <Col xxl={2} md={4}>
                    <Card className="custom-card">
                        <Card.Body className=" p-3">
                            <div className="d-flex align-items-top flex-wrap justify-content-between"> <div>
                                <div className="fw-semibold fs-15 negotiation">Negotiation</div>
                                <span className=" badge bg-light text-default">15 Leads</span> </div> <div>
                                    <span className="text-danger fw-semibold">$26,146</span> </div> </div> </Card.Body>
                    ...
                    <Card className="custom-card">
                        <Card.Body className=" p-3">
                            <div className="d-flex align-items-top flex-wrap justify-content-between"> <div>
                                ...
                                <span className=" badge bg-light text-default">127 Deals</span> </div>
                                <div> <span className="text-secondary fw-semibold">$1,74,679</span> </div> </div> </Card.Body>
