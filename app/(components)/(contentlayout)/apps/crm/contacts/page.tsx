...
import { Button, Card, Col, Dropdown, Form, InputGroup, Modal, Offcanvas, Pagination, Row, Table, OverlayTrigger, Tooltip } from 'react-bootstrap'
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <OverlayTrigger overlay={<Tooltip className="tooltip-primary">Last Contacted</Tooltip>}>
                ...
                <Offcanvas.Body className="offcanvas-body p-0">
                    <div className="d-sm-flex align-items-top p-4 border-bottom border-block-end-dashed main-profile-cover">
                        ...
                        <div className="flex-fill main-profile-info">
                            <div className="d-flex align-items-center justify-content-between">
                                ...
                                <span className="btn-close crm-contact-close-btn"
                                    onClick={handleClose}
                    ...
                    <div className="p-4 border-bottom border-block-end-dashed d-flex align-items-center">
                        ...
                        <div className="btn-list mb-0">
                            <Button variant='' className="btn btn-sm btn-icon btn-primary-light btn-wave waves-effect waves-light my-1">
                                <i className="ri-facebook-line fw-semibold"></i>
                            </Button>
                            <Button variant='' className="btn btn-sm btn-icon btn-secondary-light btn-wave waves-effect waves-light my-1">
                                <i className="ri-twitter-x-line fw-semibold"></i>
                            </Button>
                            <Button variant='' className="btn btn-sm btn-icon btn-warning-light btn-wave waves-effect waves-light my-1">
                                <i className="ri-instagram-line fw-semibold"></i>
                            </Button>
                            <Button variant='' className="btn btn-sm btn-icon btn-success-light btn-wave waves-effect waves-light my-1">
                                <i className="ri-github-line fw-semibold"></i>
                            </Button>
                            <Button variant='' className="btn btn-sm btn-icon btn-danger-light btn-wave waves-effect waves-light my-1">
                    ...
                    <div className="p-4">
                        <p className="fs-14 mb-2 fw-semibold">Relationship Manager :
                            <Link className="fs-14 text-primary mb-0 float-end" href="#!"><i className="ri-add-line me-1 align-middle"></i>Add Manager</Link>
                        </p>
