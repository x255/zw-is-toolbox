                                ...
                                <div className="d-flex flex-wrap align-items-top justify-content-between gap-2">
                                    <div>
                                        <div className="d-flex flex-wrap gap-2">
                                            ...
                                            <div>
                                                <h4 className="fw-bold mb-0 d-flex align-items-center"><Link href="#!" scroll={false}>UI Developer - Fresher</Link></h4>
                                                <Link href="#!" scroll={false} className="fw-semibold"><i className="bi bi-building"></i> Spruko Technologies .PVT.LTD</Link>
                                                ...
                                                <div className="popular-tags">
                                                    <Link href="#!" scroll={false} className="badge rounded-pill bg-info-transparent me-2"><i className="bi bi-clock me-1"></i>Full Time</Link>
                                                    <Link href="#!" scroll={false} className="badge rounded-pill bg-danger-transparent"><i className="bi bi-briefcase me-1"></i>13 Openings</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <div className="btn-list mb-2">
                                            <Link href="#!" scroll={false} className="btn btn-primary"><i className="fa fa-check me-1"></i> Apply Now</Link>
                                            <Link href="#!" scroll={false} className="btn btn-icon btn-primary-light btn-wave waves-effect waves-light">
                ...
                <Row>
                                                    ...
                                                    <Card.Body>
                                                        <div className="btn-list float-end">
                                                            <OverlayTrigger placement="top" overlay={<Tooltip>Add to wishlist</Tooltip>}>
                                                                <Link href="#!" scroll={false} className="avatar avatar-sm avatar-rounded bg-light text-default">
                                                                    <span><i className="bi bi-heart"></i></span></Link>
                                                            </OverlayTrigger>
                                                            <OverlayTrigger placement="top" overlay={<Tooltip>Featured Jobs</Tooltip>}>
                                                                <Link href="#!" scroll={false} className="avatar avatar-sm avatar-rounded bg-warning-transparent">
                                                        ...
                                                        <div className="popular-tags mb-3">
                                                            ...
                                                            <Link href="#!" scroll={false} className="badge rounded-pill bg-light text-default"><i className="bi bi-clock text-muted me-1"></i> Min - 2Years</Link>
                                                        </div>
                    ...
                    <Col xl={4}>
                        <Card className=" custom-card border">
                                ...
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item mb-2">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-2 flex-grow-1">
                                                <p className="fw-semibold fs-14 mb-1"><Link href="#!" scroll={false}> React Lead Developer</Link></p>
                                    ...
                                    <li className="list-group-item mb-2">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-2 flex-grow-1">
                                                <p className="fw-semibold fs-14 mb-1"><Link href="#!" scroll={false}> HTML Developer - Fresher</Link></p>
                                    ...
                                    <li className="list-group-item mb-2">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-2 flex-grow-1">
                                                <p className="fw-semibold fs-14 mb-1"><Link href="#!" scroll={false}> Wordpress Developer - Remote</Link></p>
                                    ...
                                    <li className="list-group-item">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-2 flex-grow-1">
                                                <p className="fw-semibold fs-14 mb-1"><Link href="#!" scroll={false}> Vuejs Frontend Developer</Link></p>
                            ...
                            <Card.Footer>
                                <Link href="#!" scroll={false} className="text-primary fw-semibold fs-14 mt-2">
                                ...
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item mb-2">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-2 flex-grow-1">
                                                <p className="fw-semibold fs-14 mb-1"><Link href="#!" scroll={false}>Infratech PVT LTD</Link></p>
                                    ...
                                    <li className="list-group-item mb-2">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-2 flex-grow-1">
                                                <p className="fw-semibold fs-14 mb-1"><Link href="#!" scroll={false}>Spruko Technologies PVT LTD</Link></p>
                                    ...
                                    <li className="list-group-item mb-2">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-2 flex-grow-1">
                                                <p className="fw-semibold fs-14 mb-1"><Link href="#!" scroll={false}>Hardware Private Solutions </Link></p>
                                    ...
                                    <li className="list-group-item mb-2">
                                        <div className="d-sm-flex">
                                            ...
                                            <div className="ms-2 flex-grow-1">
                                                <p className="fw-semibold fs-14 mb-1"><Link href="#!" scroll={false}> G Technical Solutions</Link></p>
