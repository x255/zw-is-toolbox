...
import { Progressdata, Tabledata } from '../../../../../../shared/data/apps/nft/nftdetailsdata';
import Seo from '../../../../../../shared/layout-components/seo/seo'
import Pageheader from '../../../../../../shared/layout-components/header/pageheader';
const Nftdetails = () => {

    const [thumbsSwiper, setThumbsSwiper] = useState<any>(false);
                                        ...
                                        <div className="col-xl-12 mt-xxl-0 mt-3">
                                            <div>
                                                ...
                                                <p className="fs-18 mb-4">
                                                    ...
                                                    <span className="fw-semibold text-muted"><Link className="text-info fs-14" href="#!">(2.4k Likes)</Link></span>
                                                </p>
                                                <Row className=" mb-4">
                                                ...
                                                <div className="mb-0">
                                                    ...
                                                    <Row>
                                                        <Col xxl={4} xl={12} lg={12} md={12} sm={12}>
                                                            ...
                                                            {Progressdata.map((idx: { text1: string | number | bigint | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<React.AwaitedReactNode> | null | undefined; color: string | undefined; now: number | undefined; text2: string | number | bigint | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<React.AwaitedReactNode> | null | undefined; }) => (
