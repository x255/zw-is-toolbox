...
import { Data1, Data10, Data11, Data12, Data2, Data3, Data4, Data5, Data6, Data7, Data8, Data9 } from '../../../../../shared/data/tables/tabledata'
import Link from 'next/link';
import Seo from '../../../../../shared/layout-components/seo/seo';
import Pageheader from '../../../../../shared/layout-components/header/pageheader';
import {
    tables1, tables2, tables3, tables4, tables5, tables6, tables7, tables8, tables9, tables10, tables11, tables12, tables13, tables14, tables15, tables16, tables17, tables18, tables19,
    tables20, tables21, tables22, tables23, tables24, tables25, tables26, tables27, tables28, tables29, tables30, tables31, tables32
} from '../../../../../shared/data/prismdata/tables/tables';
...
const Tables = () => {
    return (
        <>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Basic Tables" code={tables1}>
                ...
                <Col xl={6}>
                    <ShowCode title="Bordered Tables" code={tables2}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={4}>
                    <ShowCode title="Bordered Primary" code={tables3}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Bordered Success" code={tables4}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Bordered warning" code={tables5}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Table Without Borders" code={tables6}>
                        <div className="table-responsive">
                ...
                <Col xl={6}>
                    <ShowCode title="Table Group Divideres" code={tables7}>
                        <div className="table-responsive">
                            <table className="table text-nowrap">
                                <thead>
                                    <tr>
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title=" Striped rows" code={tables8}>
                        <div className="table-responsive">
                ...
                <Col xl={6}>
                    <ShowCode title="Striped columns" code={tables9}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={4}>
                    <ShowCode title="Primary Table" code={tables10}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Secondary Table" code={tables11}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Warning Table" code={tables12}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Danger Table" code={tables13}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Dark Table" code={tables14}>
                        <div className="table-responsive">
                ...
                <Col xl={4}>
                    <ShowCode title="Success Table With Striped Rows" code={tables15}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Hoverable Rows" code={tables16}>
                        <div className="table-responsive">
                ...
                <Col xl={6}>
                    <ShowCode title="Hoverable rows With striped rows" code={tables17}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Table Head Primary" code={tables18}>
                        <div className="table-responsive">
                            <table className="table text-nowrap">
                ...
                <Col xl={6}>
                    <ShowCode title="Table Head warning" code={tables19}>
                        <div className="table-responsive">
                            <table className="table text-nowrap">
                ...
                <Col xl={6}>
                    <ShowCode title="Table Head Success" code={tables20}>
                        <div className="table-responsive">
                            <table className="table text-nowrap">
                ...
                <Col xl={6}>
                    <ShowCode title="Table Head Info" code={tables21}>
                        <div className="table-responsive">
                            <table className="table text-nowrap">
                ...
                <Col xl={6}>
                    <ShowCode title="Table Head Secondary" code={tables22}>
                        <div className="table-responsive">
                            <table className="table text-nowrap">
                ...
                <Col xl={6}>
                    <ShowCode title="Table Head Danger" code={tables23}>
                        <div className="table-responsive">
                            <table className="table text-nowrap">
            ...
            <Row>
                <Col xl={4}>
                    <ShowCode title="Table Foot" code={tables24}>
                        <div className="table-responsive">
                            <table className="table text-nowrap">
                                <thead className="table-primary">
                                    <tr>
                ...
                <Col xl={4}>
                    <ShowCode title="Table With Caption" code={tables25}>
                        <div className="table-responsive">
                            <table className="table text-nowrap">
                ...
                <Col xl={4}>
                    <ShowCode title=" Table With Top Caption" code={tables26}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title=" Active Tables" code={tables27}>
                        <div className="table-responsive">
                            <table className="table text-nowrap">
                                <thead>
                                    <tr>
                ...
                <Col xl={6}>
                    ...
                    <ShowCode title="Small Tables" code={tables28}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={6}>
                    <ShowCode title="Color variants tables" code={tables29}>
                        <div className="table-responsive">
                            <table className="table text-nowrap">
                                <thead>
                                    <tr>
                ...
                <Col xl={6}>
                    <ShowCode title="Nesting" code={tables30}>
                        <div className="table-responsive">
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title=" Always Responsive" code={tables31}>
                        <div className="table-responsive">
                            <table className="table text-nowrap">
                                <thead>
                                    <tr>
            ...
            <Row>
                <Col xl={12}>
                    <ShowCode title="Vertical alignment" code={tables32}>
                        <div className="table-responsive">
