                                ...
                                <Col xxl={6} xl={7} lg={7} md={7} sm={8} className="col-12">
                                    <div className="p-5">
                                        ...
                                        <div className="btn-list">
                                            ...
                                            <Button variant='light' className="btn btn-icon"><i className="ri-twitter-x-fill"></i></Button>
                                        </div>
                                        ...
                                        <div className="row gy-3">
                                            ...
                                            <Col xl={12} className=" mb-3">
                                                <Form.Label htmlFor="signin-password" className="form-label text-default d-block">Password<Link href={`/authentication/reset-password/cover`} className="float-end text-danger">Forget password ?</Link></Form.Label>
                                                <InputGroup>
                                        ...
                                        <div className="text-center">
                                            <p className="fs-12 text-muted mt-4">Dont have an account? <Link href={`/authentication/sign-up/cover/`} className="text-primary">Sign Up</Link></p>
                                        </div>
                                    </div>
                                </Col>
                            </div>
